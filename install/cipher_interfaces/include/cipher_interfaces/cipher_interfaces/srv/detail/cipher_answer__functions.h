...
#ifndef CIPHER_INTERFACES__SRV__DETAIL__CIPHER_ANSWER__FUNCTIONS_H_
#define CIPHER_INTERFACES__SRV__DETAIL__CIPHER_ANSWER__FUNCTIONS_H_
...
#include "cipher_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "cipher_interfaces/srv/detail/cipher_answer__struct.h"

/// Initialize srv/CipherAnswer message.
/**
...
/// Create srv/CipherAnswer message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cipher_interfaces__srv__CipherAnswer_Request__init().
...
/// Destroy srv/CipherAnswer message.
/**
 * It calls
 * cipher_interfaces__srv__CipherAnswer_Request__fini()
...
/// Check for srv/CipherAnswer message equality.
/**
...
/// Copy a srv/CipherAnswer message.
/**
...
/// Initialize array of srv/CipherAnswer messages.
/**
...
/// Finalize array of srv/CipherAnswer messages.
/**
 * It calls
 * cipher_interfaces__srv__CipherAnswer_Request__fini()
...
/// Create array of srv/CipherAnswer messages.
/**
 * It allocates the memory for the array and calls
 * cipher_interfaces__srv__CipherAnswer_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CipherAnswer messages.
/**
 * It calls
 * cipher_interfaces__srv__CipherAnswer_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CipherAnswer message array equality.
/**
...
/// Copy an array of srv/CipherAnswer messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cipher_interfaces__srv__CipherAnswer_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cipher_interfaces
...
/**
 * It calls
 * cipher_interfaces__srv__CipherAnswer_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cipher_interfaces
...
/**
 * It allocates the memory for the array and calls
 * cipher_interfaces__srv__CipherAnswer_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cipher_interfaces
...
/**
 * It calls
 * cipher_interfaces__srv__CipherAnswer_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CIPHER_INTERFACES__SRV__DETAIL__CIPHER_ANSWER__FUNCTIONS_H_
